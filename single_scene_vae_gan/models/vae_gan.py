...
class Encoder(nn.Module):
  def __init__(self):
    ...
    self.conv4=nn.Conv2d(256,256,5,padding=2,stride=1)
    self.bn4=nn.BatchNorm2d(256,momentum=0.9)
    self.conv6=nn.Conv2d(256,256,5,padding=2,stride=1)
    self.bn6=nn.BatchNorm2d(256,momentum=0.9)
    self.relu=nn.LeakyReLU(0.2)
    self.fc1=nn.Linear(256*8*8,2048)
    self.bn5=nn.BatchNorm1d(2048,momentum=0.9)
...
class Decoder(nn.Module):
  def __init__(self):
    ...
    self.relu=nn.LeakyReLU(0.2)
    self.deconv0=nn.ConvTranspose2d(256,256,5, stride=1, padding=2)
    self.bn0=nn.BatchNorm2d(256,momentum=0.9)
    self.deconv01=nn.ConvTranspose2d(256,256,5, stride=1, padding=2)
    self.bn01=nn.BatchNorm2d(256,momentum=0.9)
  ...
  def forward(self,x):
    ...
    x=x.view(-1,256,8,8)
    x=self.relu(self.bn0(self.deconv0(x)))
    x=self.relu(self.bn01(self.deconv01(x)))
...
class Discriminator(nn.Module):
  def __init__(self):
    ...
    self.bn3=nn.BatchNorm2d(256,momentum=0.9)
    self.conv5=nn.Conv2d(256,256,5,padding=2,stride=1)
...
class VAE_GAN(nn.Module):
  ...
  def forward(self,x):
    ...
    epsilon=Variable(torch.randn(bs,128)).to(x.device)
    # z는 latent variable
